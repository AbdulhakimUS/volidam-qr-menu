...
export const STR: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    saved: 'Сохранено',
    deleted: 'Удалено',
    fillRequired: 'Заполните название, цену и категорию',
    category: 'Категория',
    selectCategory: 'Выберите категорию',
    noCategories: 'Сначала добавьте категории через API (sections / categories)',
    itemsCount: 'позиций',
    menuManage: 'Меню',
    allItems: 'Все блюда',
    theme: 'Тема',
  ...
  uz: {
    ...
    saved: 'Saqlandi',
    deleted: "O'chirildi",
    fillRequired: "Nomi, narxi va kategoriyani to'ldiring",
    category: 'Kategoriya',
    selectCategory: 'Kategoriyani tanlang',
    noCategories: "Avval API orqali kategoriyalar qo'shing (sections / categories)",
    itemsCount: 'ta taom',
    menuManage: 'Menyu',
  ...
  en: {
    ...
    saved: 'Saved',
    deleted: 'Deleted',
    fillRequired: 'Fill in name, price and category',
    category: 'Category',
    selectCategory: 'Select a category',
    noCategories: 'Add categories via API first (sections / categories)',
    itemsCount: 'items',
    menuManage: 'Menu',
    allItems: 'All dishes',
    theme: 'Theme',
